...
such as the official [kubernetes client](https://github.com/kubernetes-client/python), [pykorm](https://github.com/Frankkkkk/pykorm), or [pykube-ng](https://github.com/hjacobs/pykube).
...
To label the resources to be created, use [`kopf.label()`](packages/kopf.md#kopf.label):
...
To set the ownership, use [`kopf.append_owner_reference()`](packages/kopf.md#kopf.append_owner_reference).
To remove the ownership, use [`kopf.remove_owner_reference()`](packages/kopf.md#kopf.remove_owner_reference):
...
To give the resource(s) a name, use `kopf.harmonize_naming()`.
...
All of the above can be done in one call with [`kopf.adopt()`](packages/kopf.md#kopf.adopt); `forced`,
...
Currently, that is [pykube-ng](https://github.com/hjacobs/pykube) (classes based on `pykube.objects.APIObject`)
and [kubernetes client](https://github.com/kubernetes-client/python) (resource models from `kubernetes.client.models`).
