...
An index is always a read-only *mapping* of type [`kopf.Index`](packages/kopf.md#kopf.Index)
...
[`kopf.PermanentError`](packages/kopf.md#kopf.PermanentError) and arbitrary exceptions with `errors=PERMANENT`
